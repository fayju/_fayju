...
function PostNotification (aSender:GameObject, aName: String) { PostNotification(aSender, aName, ""); }
...
function PostNotification (aSender:GameObject, aName: String, eData:Hashtable) { PostNotification(new Notification(aSender, aName, eData)); }
...
class Notification {
	...
	function Notification (aSender:GameObject, aName: String, eData:Hashtable) { sender = aSender; name = aName; edata = eData; }
}