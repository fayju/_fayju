...
class MeshObject extends MonoBehaviour{
	...
	protected var lightMapUV:Vector2[];
	protected var displaytriangles:int[];
	
	//|0.76|0.7|0.66|0.7|0.68|0.66|0.66|0.7|0.4|0.6|0.68|0.54|0.8|0.7|0.82|0.66|0.82|0.66|0.64|0.64|0.72|0.74|1|0.66|0.66|0.72|0.76|0.7|0.66|0.7|0.68|0.66|0.66|0.7|0.4|0.6|0.68|0.54|0.8|0.7|0.82|0.66|0.82|0.66|0.64|0.64|0.72|0.74|1|0.66|0.66|0.72|0.74|0.48|0.72|0.7|0.68|0.72|0.7|0.68|0.7|0.7|0.45|1.0|1.0|1.0|0.66|0.66|1.0|1.0|1.0
	...
	/*	if(quadManager)
			DestroyImmediate(quadManager, true);
		if(meshRenderer)
	...
	function populateMesh():void{
			...
			lightMapUV = new Vector2[vertCount];
	...
	function updateSpriteLetter(letter:SpriteDefinition):void{
		...
		//updateLightMap(letter, true);
	}
	function updateLightMap(letter:SpriteDefinition, arect:Rect, forceMeshUpdate:boolean):void{
		//;

		if(letter.isInited){


				var uvQuad:UVQuad = new UVQuad();
				uvQuad.fastMap(arect.x, arect.y , arect.width, arect.height) ;//quadManager.getLetterQuad(letter.letter);
				if(uvQuad != null){
				lightMapUV[letter.A] = uvQuad.A;
				lightMapUV[letter.B] = uvQuad.B;
				lightMapUV[letter.C] = uvQuad.C;
				lightMapUV[letter.D] = uvQuad.D;
				if(forceMeshUpdate){
					mesh.uv2 = lightMapUV;
				}
			}
	...
	function updateLightMap(letter:SpriteDefinition, forceMeshUpdate:boolean):void{
	 
		 updateLightMap(letter,Rect (0, 0, 1, 1), forceMeshUpdate );
	}
